...
class HeteroRGCN(nn.Module):
    ...
    def forward(self, g, features):
        ...
        # For example, you could add a function that does a different kind of operation on the graph,
        # or add an auxiliary feature to be passed to the forward function.
